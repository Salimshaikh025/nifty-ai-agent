...
<body>
<script>console.log("JSTEST-OK: JavaScript is running on this page.");</script>
<div style="text-align:center; color:#0f0; font-size:11px; padding:4px;">BUILD-FIX-v5</div>
