...
<div style="text-align:center; color:#0f0; font-size:11px; padding:4px;">BUILD-FIX-v6</div>
...
async function update() {
    ...
    try {
        ...
        setText("entry", d.entry_price != null ? "₹" + Number(d.entry_price).toFixed(2) : "--");
        setText("current", d.current_price != null ? "₹" + Number(d.current_price).toFixed(2) : "--");
        setText("sl", d.stop_loss != null ? "₹" + Number(d.stop_loss).toFixed(2) : "--");
        setText("target", d.target != null ? "₹" + Number(d.target).toFixed(2) : "--");
...
async function turnOn() {
    ...
    if (amount > 10000) { alert("Maximum daily amount is ₹10,000."); return; }
